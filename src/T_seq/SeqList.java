...
public class SeqList<T> extends Object implements List_Seq<T> {
    ...
    public int append(T x)                                 //顺序表尾插入x元素，返回x序号。成员方法重载
    {
    ...
    public void removeMINtoMAX(T x, T y) {
    ...
    public void intersection(SeqList A,SeqList B,SeqList C){
        int k=0;
        int h=0;
        for (int i = 0; i < A.n; i++) {
            for (int j = 0; j < B.n; j++) {
